...
describe('Time limit enforcement', () => {
    ...
    describe('admitSession', () => {
        ...
        //
        //  The seam login() and login2FA_OTP() both go through. That they
        //  call it at all is not covered here -- userLogin() needs a real
        //  database and system_menu_method.js captures it at require time --
        //  and was checked against a running board instead.
        //
